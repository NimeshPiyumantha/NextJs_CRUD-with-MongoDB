...
export default function Home() {
  ...
  return (
    <section>
      ...
      <main className="py-6 px-10 bg-white">
        <div className="bg-accent-white-100 mx-16 my-10 p-10 rounded-2xl opacity-80 bg-center shadow-2xl">
          <h1 className="text-xl md:text-4xl text-center font-bold py-6">
            Employee Management
          </h1>
